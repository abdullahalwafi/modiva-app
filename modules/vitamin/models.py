...
class Distribusisiswa(models.Model):
    ...
    tgl_terima = models.DateField(blank=True, null=True)
    tanggal_konsumsi = models.DateField(blank=True, null=True)
    kelas = models.CharField(max_length=10, blank=True, null=True)
    status_konsumsi = models.CharField(max_length=20, blank=True, null=True, default='belum')
    bukti_foto = models.ImageField(upload_to='uploads/bukti_konsumsi/', validators=[FileExtensionValidator(['jpg','jpeg','png','JPG','JPEG','PNG'])], blank=True, null=True)
